...
METHOD_SPEC = {
    "algorithm_id": "P099-Ranka-DataMining",
    "algorithm_name": "RankaProvenanceDataMiningExplainAgent",
    "project_family": "ml",
    ...
    "decision_rule": "Rank seed cases by ml-specific priority score with Ranka-aligned focus term 'Data mining'.",
